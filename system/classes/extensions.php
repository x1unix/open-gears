...
class Extensions
{
    ...
    /**
     * Call and register a single extension
     *
     * @param $e
     * @return Extensions
     * @throws ExtensionNotFoundException
    ...
    private static function call($e) {
        if(!isset(System::$Scope["extensions"]))
            System::$Scope["extensions"] = array();
        ...
        if(!file_exists($e)) 
            throw new ExtensionNotFoundException("Selected extension file not found and cannot be loaded: '".$e."'");
     ...
     * @return bool
     */
    public static function exists($e) { 
        return defined("KEXT_".strtoupper($e)); 
    }
    ...
    {
        if(!self::exists($e)) 
            throw new ExtensionNotLoadedException("This module requires a extension, which has not been loaded: '".$e."'");
    }
}
